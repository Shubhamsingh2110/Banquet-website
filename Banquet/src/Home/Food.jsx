export function FeaturedMeals() {
  ...
  return (
    <section className=" mx-auto px-4 py-10">
      ...
      `}</style>
      {/* Centered Heading */}
      <h1 className="text-7xl font-black text-center mb-10 text-[#B38B59] font-cormorant">Food</h1>
