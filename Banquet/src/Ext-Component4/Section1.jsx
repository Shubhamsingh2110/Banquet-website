  ...
  return (
    ...
    >
      ...
      <nav className="flex items-center justify-between px-6 pt-7 relative max-w-7xl mx-auto z-10">
       ...
       <button className="bg-white text-black hover:bg-gray-200 rounded-[20px] px-6 py-3 font-medium transition-colors">
          Join The Waitlist
        </button>
      ...
      <div className="flex flex-col items-center justify-center min-h-[80vh] px-6 relative z-10">
        {/* Waitlist Badge */}
        <div className="flex items-center bg-white/10 rounded-[15px] px-4 py-[6px]  mb-3">
        ...
        <div className="text-center mb-8">
          <h1 className="text-5xl md:text-8xl font-normal text-white mb-2">Building the Future</h1>
          <h2 className="text-3xl md:text-7xl font-playfair  italic text-white/80">One Startup at a Time.</h2>
        </div>

        {/* Subtext */}
        <p className="text-white/50 text-lg md:text-2xl text-center max-w-2xl mb-12">
